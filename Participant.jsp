...
/*        function editRecord(id){
  ...
  */      </script>
        ...
        <table align="center" cellpadding="5" cellspacing="5" border="1">
            <tr bgcolor="#DEB887"><th>EventId</th><th>EventName</th><th>StudentId</th><th>FirstName</th><th>LastName</th><th>CollegeName</th><th>Email</th><th>Mobile</th></tr>
        <%
        Connection con = null;
        ...
        String query = " select p.EventId,e.EventName,p.email_id,s.first_name,s.last_name,s.college_name,s.email_id,s.mobile from participant p,studentsignup s,events e where p.EventId=e.EventId and p.email_id=s.email_id and e.ClgEmail='" +user+ "'";
